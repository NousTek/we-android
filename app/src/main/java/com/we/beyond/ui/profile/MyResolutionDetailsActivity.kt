...
import com.we.beyond.adapter.ResolutionAdapter
...
import com.we.beyond.presenter.profile.myResolution.MyResolutionDetailsImpl
import com.we.beyond.presenter.profile.myResolution.MyResolutionDetailsPresenter
...
/**
 * It shows the resolution details perform further actions
 */
class MyResolutionDetailsActivity : AppCompatActivity(),
    MyResolutionDetailsPresenter.IMyResolutionDetailsView,
    ...
    var isseIdPresenter: MyResolutionDetailsImpl? = null
    ...
    var resolutionAdapter: ResolutionAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_resolution_details)
        ...
        isseIdPresenter = MyResolutionDetailsImpl(this)
        ...
        if (issueId != null && issueId!!.isNotEmpty()) {
            ...
            try {
                if (ConstantMethods.checkForInternetConnection(context)) {
                    ...
                    isseIdPresenter!!.onMyResolutionDetails(this, pageNo, 10000, issueId!!)
                }
            } catch (e: Exception) {
                e.printStackTrace()
            }
 ...
 */
        ...
        /** It calls again onMyResolutionDetails function of issue id presenter
     ...
     */
    override fun setMyResolutionDetailsAdapter(issueDetails: ReportedResolutionDetailsPojo) {
...
//                        .placeholder(R.drawable.loading_image)
                ...
                if (issueDetails.data.resolutions != null) {
                    ...
                    if (commentPosition != null) {
                        ...
                        resolutionAdapter =
                            ResolutionAdapter(this, resolutionArray!!, userId, isIssueResolved)
