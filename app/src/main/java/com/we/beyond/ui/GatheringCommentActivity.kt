...
import com.we.beyond.adapter.GatheringCommentDetailsAdapter
...
/**
 * It shows the gathering comments details perform further actions
 */
class GatheringCommentActivity : AppCompatActivity() , CommentDetailsPresenter.ICommentsByIdView,
    ...
    var commentsAdapter: GatheringCommentDetailsAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gathering_comment)
    ...
    private fun getDataToPostOnAbuse() {
        try {
            ...
            if (abuseEditText!!.text.trim() != null && abuseEditText!!.text.trim().isNotEmpty()) {
                ...
                if (ConstantMethods.checkForInternetConnection(this@GatheringCommentActivity)) {

                    val jsonObject = JsonObject()
                    jsonObject.addProperty("type", "gatheringId")
    ...
    private fun initWithListener() {
        ...
        /** It closes the more layout with animation
         * get stored user id and check with near by reply user id, if matches then we cannot abuse the gathering
 ...
 */
         ...
         * If stored user id and reply user id matches,
         * it will show dialog to delete comment and call deleteComment() api
         */
        ...
        /** It closes the more layout with animation
         * it checks tags of user and add it in array and call onEdit() of listener
        ...
        closeComment!!.setOnClickListener {
            ...
            ConstantMethods.hideKeyBoard(this, this@GatheringCommentActivity)
    ...
    override fun setCommentsByIdAdapter(commentsDetails: CommentDetailsPojo) {
        ...
        if (commentsDetails != null) {
            ...
            try {
                ...
                println("comment data $commentsDetails")
        ...
        if (commentsDetails.data.reply != null) {
            ...
            commentsAdapter = GatheringCommentDetailsAdapter(context, commentArray!!, commentsDetails)
