...
import com.we.beyond.ui.profile.ReportedResolutionActivity
...
/** It binds reported resolution data set to views */
class ReportedResolutionAdapter(
    val context: Context,
    issueDetails: ArrayList<NearByIssues>
) : RecyclerView.Adapter<ReportedResolutionAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        try {
            ...
            holder.locationLayout.setOnClickListener {
                ...
                (context as ReportedResolutionActivity).overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
...
//                    .placeholder(R.drawable.loading_image)
            ...
            holder.issueResolvedCount.text =
                "Resolution Count : ${issueDetails!![position].resolutionsCount}"
            holder.issueResolvedCount.typeface = ConstantFonts.raleway_semibold


            /** It opens ReportedResolutionDetailsActivity with pass going id when click on it */
            holder.itemView.setOnClickListener {

                val intent = Intent(context, ReportedResolutionDetailsActivity::class.java)
                ...
                (context as ReportedResolutionActivity).startActivityForResult(intent, 200)
                (context as ReportedResolutionActivity).overridePendingTransition(
                    R.anim.slide_in_right,
                    R.anim.slide_out_left
                )
                // (context as ReportedResolutionActivity).finish()
