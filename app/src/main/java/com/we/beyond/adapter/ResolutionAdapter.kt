...
/** It binds resloution data set to views */
class ResolutionAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        try {
            ...
            /** show and hide image views and call onDislike function of onLikeDislikeListener */
 ...
 */
            ...
            holder.delete.setOnClickListener {
                ...
                (context as MyResolutionDetailsActivity).resolutionAdapter!!.notifyDataSetChanged()
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    val response: Single<DeleteReportedResolutionPojo> =
                                        resolutionApi.deleteResolution(jsonObject)
                                                ...
                                                if (deleteReportedResolutionPojo != null) {
                                                    ...
                                                    for (i in 0 until deleteConnectList.size) {
                                                        ...
                                                        if (deleteConnectList[i]._id == issueId) {
                                                            deleteConnectList.remove(
                                                                deleteConnectList[i]
                                                            )
                                                            resolutionDetails!!.clear()
                                                            resolutionDetails!!.addAll(
                                                                deleteConnectList
                                                            )
                                                            (context as MyResolutionDetailsActivity).resolutionAdapter!!.notifyDataSetChanged()
                ...
                try {
                    ...
                    if (userId == resolutionDetails!![position].user._id) {
                        ...
                        ConstantMethods.showWarning(
                            context,
                            "",
                            "You can not abuse your resolution."
                        )
                    } else if (resolutionDetails!![position].commentType.equals(
                            "resolution",
                            ignoreCase = true
                        ...
                        ConstantMethods.showWarning(
                            context,
                            "",
                            "You can not abuse approved resolution."
                        )
                    } else if (resolutionDetails!![position].commentType.equals(
                            "resolution",
                            ignoreCase = true
                ...
                if (userId == resolutionDetails!![position].user._id && resolutionDetails!![position].commentType.equals(
                    ...
                    if (userId == resolutionDetails!![position].user._id) {
                        try {
                            ...
                            (context as MyResolutionDetailsActivity).overridePendingTransition(
                                R.anim.slide_in_right,
                                R.anim.slide_out_left
                            )
